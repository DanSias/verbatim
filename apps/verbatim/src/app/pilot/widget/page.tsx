...
export default function WidgetDemoPage() {
  ...
  return (
    <div className="max-w-4xl mx-auto">
      <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mb-2">Widget Demo</h1>
      <p className="text-gray-600 dark:text-gray-300 mb-8">
        This page demonstrates the documentation assistant widget that will be embedded in the docs
        site. The widget communicates via <code className="bg-gray-100 dark:bg-gray-800 px-1 rounded">/api/widget/answer</code>,
        which proxies requests to the internal answer API with server-side configuration.
      </p>

      {/* Widget Status */}
      <div className="mb-8 p-4 rounded-lg border border-gray-200 dark:border-gray-800 bg-gray-50 dark:bg-gray-900">
        <h2 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-2">Widget Status</h2>
      ...
      <div className="mb-8 p-4 rounded-lg border border-purple-200 dark:border-purple-900/40 bg-purple-50 dark:bg-purple-900/20">
        <h2 className="text-lg font-semibold text-purple-900 dark:text-purple-200 mb-2">Workspace Override</h2>
        <p className="text-sm text-purple-700 dark:text-purple-300 mb-3">
          Override the workspace ID for testing. This sends{' '}
          <code className="bg-purple-100 dark:bg-purple-900/40 px-1 rounded">x-verbatim-workspace-id</code> header with requests.
        </p>
        <div className="flex gap-2">
          <input
            ...
            className="flex-1 px-3 py-2 bg-white dark:bg-gray-950 border border-purple-300 dark:border-purple-900/60 rounded-md text-sm text-gray-900 dark:text-gray-100 placeholder:text-gray-400 dark:placeholder:text-gray-500 focus:outline-none focus:ring-2 focus:ring-purple-500"
          />
          <button
            onClick={handleSaveWorkspace}
            disabled={workspaceOverride === savedWorkspace}
            className="px-4 py-2 bg-purple-600 hover:bg-purple-700 disabled:bg-purple-300 dark:disabled:bg-purple-900/30 text-white text-sm font-medium rounded-md transition-colors"
          >
            Save
          </button>
          <button
            ...
            className="px-4 py-2 bg-gray-500 hover:bg-gray-600 disabled:bg-gray-300 dark:disabled:bg-gray-700 text-white text-sm font-medium rounded-md transition-colors"
          >
            Clear
          </button>
        </div>
        {savedWorkspace && (
          <div className="mt-2 flex items-center gap-2">
            <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-purple-200 dark:bg-purple-900/40 text-purple-900 dark:text-purple-200">
      ...
      <div className="mb-8 p-4 rounded-lg border border-blue-200 dark:border-blue-900/40 bg-blue-50 dark:bg-blue-900/20">
        <h2 className="text-lg font-semibold text-blue-900 dark:text-blue-200 mb-2">Architecture</h2>
        <div className="text-sm text-blue-800 dark:text-blue-300 space-y-2">
          <p>
            <strong>Current (Verbatim demo):</strong>
          </p>
          <pre className="bg-blue-100 dark:bg-blue-900/40 p-2 rounded text-xs overflow-x-auto">
...
{`Browser → /api/widget/answer → VERBATIM_BASE_URL/api/answer (external)`}
      ...
      {/* Inline Test Form */}
      <div className="mb-8 p-4 rounded-lg border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900">
        <h2 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-4">API Test Form</h2>
        <p className="text-sm text-gray-600 dark:text-gray-400 mb-4">
          Test the <code className="bg-gray-100 dark:bg-gray-800 px-1 rounded">/api/widget/answer</code> endpoint
          directly:
        </p>

        <form onSubmit={handleTestSubmit} className="space-y-4">
          <div>
            <label htmlFor="test-question" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
              Question
            </label>
            <input
              id="test-question"
              ...
              className="w-full px-3 py-2 bg-white dark:bg-gray-950 border border-gray-300 dark:border-gray-700 rounded-md text-sm text-gray-900 dark:text-gray-100 placeholder:text-gray-400 dark:placeholder:text-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500"
        ...
        {testResponse && (
          <div className="mt-4">
            <h3 className="text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2">Response:</h3>
      ...
      <div className="p-4 rounded-lg border border-gray-200 dark:border-gray-800 bg-gray-50 dark:bg-gray-900">
        <h2 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-2">Environment Variables</h2>
