    ...
    <div className="space-y-6">
      ...
      <div className="bg-white border border-gray-200 rounded-lg p-6 space-y-6">
        ...
        <div>
          ...
          <p className="mt-2 text-xs text-gray-500">
            {corpus === 'docs' ? (
              <>
                <strong>docs:</strong> Only <code className="bg-gray-100 px-1 rounded">page.mdx</code> files. Route derived from relative path.
              </>
            ) : (
              <>
                <strong>kb:</strong> All <code className="bg-gray-100 px-1 rounded">.md</code> files. Identity derived from relative path. No routes.
              </>
            )}
          </p>
        </div>
        ...
        <div>
          ...
          {selectedFiles.length > 0 && (
            <div className="mt-3">
              ...
              <div className="max-h-40 overflow-y-auto border border-gray-200 rounded bg-gray-50 p-2">
                <ul className="text-xs text-gray-600 space-y-0.5">
                  ...
                  {remainingCount > 0 && (
                    <li className="text-gray-400">+{remainingCount} more</li>
                  )}
                </ul>
              </div>
            </div>
                  ...
                  <tr key={i} className="hover:bg-gray-50">
                    ...
                    <td className="px-3 py-2 text-xs text-gray-600">
                      ...
                      {result.status === 'ok' && result.route && (
                        <span className="ml-2 text-blue-600">{result.route}</span>
                      )}
                      {result.error && (
      ...
      <div className="bg-gray-50 border border-gray-200 rounded-lg p-4">
        <p className="text-sm text-gray-600">
          ...
          <code className="bg-gray-200 px-1 rounded">/fixtures/docs</code> and{' '}
          <code className="bg-gray-200 px-1 rounded">/fixtures/kb</code>.
          Use folder upload to ingest them with correct paths.
        </p>
      </div>
    </div>
  );
